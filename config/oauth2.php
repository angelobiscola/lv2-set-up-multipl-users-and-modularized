    ...
    */
    ...
    'grant_types' => [
        ...
        'user' => [
            ...
            'callback' => 'App\Application\Web\User\Http\Controllers\Auth\AuthController@verify',
            'access_token_ttl' => 3600
        ],

        'admin' => [
            'class'    => '\League\OAuth2\Server\Grant\PasswordGrant',
            'callback' => 'App\Application\Web\Admin\Http\Controllers\Auth\AuthController@verify',
            'access_token_ttl' => 3600
        ]
    ],
